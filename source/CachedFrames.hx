...
class CachedFrames
{
    ...
    public function loadFrames()
    {
        sys.thread.Thread.create(() -> {
            toBeLoaded.set('left','adp/nite/Left');
            toBeLoaded.set('right','adp/nite/right');
            toBeLoaded.set('up','adp/nite/Up');
            toBeLoaded.set('down','adp/nite/Down');
            toBeLoaded.set('idle','adp/nite/Idle');
            toBeLoaded.set('rock','adp/nite/Rock');
            // all the big sprites
            var numba = 0;
